...
<style type="text/css">
  ...
  <div class="row ">
      ...
      <div class="col-md-7 " align="" style="color:;padding:0% 2% 5% 0%;">
      <div class="box-sdow" align="" style="color:;padding:5% 3% 5% 1%;">
      <div class="col-md-12 body-data" style="padding-bottom:10px;"> <h3><i class="fa fa-fw fa-archive"></i> &nbsp;&nbsp;Choose Type/course in your institute</h3></div>
       ...
       <div class="dropdown-menu dropdown-menu-right" aria-labelledby="corcatgo" style=" left:-164px; width:200px;">
        ...
        <br>
          ...
          <div class="respopad40" style="position:relative;padding-bottom:15px;"><img src="<?php echo base_url().'assets-public/' ?>dist/img/icon/search.svg" class="srch-icon"><img src="<?php echo base_url().'assets-public/' ?>dist/img/icon/x-circle.svg" id="srch-close" class="srch-close"><div class="srch-loader"><div class="sbl-circ-path3"></div></div>
            <input type="text" class="cus-srch-input" placeholder="Search..">

          </div>
        </div>

      <div id="allcours-val" class="col-md-12 " align="" style="height:370px; overflow-x:hidden;overflow-y:scroll;">
    
      </div>

      <div id="coursesrch-val" class="col-md-12 " align="" style="height:370px; overflow-x:hidden;overflow-y:scroll; display:none;">
     ...
     <div class="col-md-5 " align="" style="color:;padding:0% 0% 5% 0%; ">
      <div class="box-sdow" align="" style="color:;padding:5% 0% 5% 1%;">
      <div class="col-md-12 body-data" style="padding-bottom:10px;"> <h3><i class="fa fa-fw fa-magic"></i> &nbsp;&nbsp;Our/My institute Courses </h3></div>
...
<div class="modal fade" id="addcourse" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 $(document).on('click', '.catitemid', function(){  
  ...
  $(document).on('click', '.catthisaddid', function(){  
