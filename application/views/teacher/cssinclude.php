  ...
  <link rel="stylesheet" href="<?php echo base_url().'assets-public/' ?>bower_components/animate.css/animate.min.css">
  <!-- Ionicons -->
...
<style type="text/css">
  ...
  <link rel="stylesheet" href="<?php echo base_url().'assets-public/' ?>dist/css/skins/skin-blue.min.css">
  <link rel="stylesheet" href="<?php echo base_url().'assets-public/' ?>dist/css/cus.css?cat=1783">
   <link rel="stylesheet" href="<?php echo base_url().'assets-public/' ?>dist/css/bootstrap-material-design.min.css"> 
<link href="<?php echo base_url().'assets-public/' ?>dist/css/gijgo.min.css" rel="stylesheet" type="text/css" />
  <!-- <script src="<?php echo base_url().'assets-public/' ?>dist/js/jquery-3.1.1.min.js"></script>-->
    <script src="<?php echo base_url().'assets-public/' ?>dist/js/jquery-3.3.1.min.js"></script>
    <script src="<?php echo base_url().'assets-public/' ?>dist/js/gijgo.min.js" type="text/javascript"></script>
