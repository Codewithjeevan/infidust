 ...
 <div class="row" style="height:50px;"></div>
  ...
  <div id="profdatablk" class="row" style="display:">
      <div class="col-md-6 " align="" style="color:;padding:7% 3% 5% 5%">
        ...
        <form id="updateproffrom" enctype="multipart/form-data" action="<?php echo base_url();?>teacher/Updateprofile" method="post">
  ...
  <div id="persodatablk" class="row" style="display:none">
      <div class="col-md-6 " align="" style="color:;padding:7% 3% 5% 5%">
        ...
        <form id="updateproffromtwo" enctype="multipart/form-data" action="<?php echo base_url();?>teacher/Updateprofiletwo" method="post">
        <div class="form-group">
