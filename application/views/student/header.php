...
<div class="side-menu">
  <button type="button" class="btn btn-primary btn-block sidebtn sidemactiv " style="margin: 0;" onclick="openNavipageStart('student','dashboard');"><img src="<?php echo base_url().'assets-public/' ?>dist/img/icon/home.svg"> Home</button>
  <brktxt>Live</brktxt>
  <!-- <button type="button" class="btn btn-primary btn-block sidebtn <?php if($inst_plan == 'X'){echo 'openliveinst';}else if($inst_plan == 'B'){echo 'opennolivecls';}else{ echo 'openliveclass';} ?> " style="margin: 0;"><img src="<?php echo base_url().'assets-public/' ?>dist/img/icon/smile.svg"> Live Class</button> -->
  <button type="button" class="btn btn-primary btn-block sidebtn" style="margin: 0;" onclick="openNavipage('testexam','test_dashboard_student');"><img src="<?php echo base_url().'assets-public/' ?>dist/img/icon/test.svg" > Test series</button>
  <brktxt>Materials</brktxt>
  <button type="button" class="btn btn-primary btn-block sidebtn open_viewlist" style="margin: 0;"  onclick="openNavipage('viewlist','view_list');"><img src="<?php echo base_url().'assets-public/' ?>dist/img/icon/archive.svg"> Videos & Notes</button>
  
 <brktxt>Settings</brktxt>
 <?php if($crnt_inst_data){ ?>
   <button type="button" class="btn btn-primary btn-block sidebtn " style="margin: 0;" onclick="openNavipage('student','my_class_course');"><img src="<?php echo base_url().'assets-public/' ?>dist/img/icon/list.svg"> My active <?php if($crnt_inst_data['mem_sub_typ'] == 'school'){ echo 'classes'; }else { echo 'courses';}?>
   </button>
   <?php } ?>
  <button type="button" class="btn btn-primary btn-block sidebtn " style="margin: 0;" onclick="openNavipage('student','institue_profile');"><img src="<?php echo base_url().'assets-public/' ?>dist/img/icon/briefcase.svg"> Profiling</button>
 <button type="button" class="btn btn-primary btn-block sidebtn " style="margin: 0;" onclick="openNavipage('gsetting','account_setting');"><img src="<?php echo base_url().'assets-public/' ?>dist/img/icon/settings.svg"> Setting</button>
