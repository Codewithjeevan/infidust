...
<head>
  ...
  <title><?php echo $main_menu['p_title']; ?></title>
  ...
  <meta name="description" content="<?php echo @$main_menu['p_des']; ?>"/>
  <meta name="keywords" content="<?php echo @$main_menu['p_keywords']; ?>" />
  <link rel="canonical" href="<?php echo base_url().$canonical ?>" />
  <?php echo @$main_menu['oth_keywords']; ?>
