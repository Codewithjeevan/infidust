...
<div class="row">
    ...
    <div class="col-md-12" style="padding:10px 0px 20px 0px;;">
      ...
      <?php foreach ($myclassnm as $myclassnm) { 
        ...
        <div class="radio">
        <label>
          <input type="radio" name="optionsRadios" id="<?php echo $myclassnm['class_uid']; ?>" value="<?php echo $myclassnm['class_uid']; ?>"  class="allchekb">
...
First create your course and subjects wise class batches in settings.
 ...
 <script>$(document).ready(function() { $('div').bootstrapMaterialDesign(); });</script>
     ...
     $(document).ready(function() {
            $("#memberlist").load('<?php echo base_url()."dashboard/alot_mem_list_student"; ?>');
...
var membjarr = new Array();
  ...
  // $(document).on('click', '#tea_dac_btn', function(){  
   ...
   $('#formem').val('teacher');
   membjarr = new Array();
    $("#memberlist").load('<?php echo base_url()."dashboard/alot_mem_list_teacher"; ?>');
  });
