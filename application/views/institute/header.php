...
.alert-waitiner {  width: 220px; height: 60px; background: #000;  
   ...
   .v-inup-min { width: 32px; height: 32px; border:1px solid #fff; position: absolute; top: 2px; left: 10px; border-radius: 100px; background-size: 120px; background-position: center center }
</style>
...
<table width="100%">
  <tr>
    ...
    <td><span id="erro-msg">Update faild...</span></td>
  </tr>
</table>
</div>
</div>
...
<div class="side-menu">
  ...
  <!-- <button type="button" class="btn btn-primary btn-block sidebtn open_materials_edit" style="margin: 0;"><img src="<?php echo base_url().'assets-public/' ?>dist/img/icon/archive.svg"> Videos & Notes</button> -->
  ...
  <button type="button" class="btn btn-primary btn-block sidebtn open_allteacher" style="margin: 0;"><img src="<?php echo base_url().'assets-public/' ?>dist/img/icon/usert.svg"> My Teachers</button>
