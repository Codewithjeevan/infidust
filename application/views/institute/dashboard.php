                ...
                <table width="100%">
                  ...
                  <td></td>
                    <td height="70" >
                      ...
                      <div class="c-title">Complete all these steps for coming live in 5 minutes!</div>
                  ...
                  <tr>
                    ...
                    <td>
                              ...
                              <?php if($ins_subject){ ?>
                                 <h3><i class="fa fa-fw fa-check-circle" style="color:green;font-size:16px;"></i> Courses/Subject</h3>
                                 <?php }else{ ?>
                                 <h3><i class="fa fa-fw fa-check-circle-o" style="color:#ccc;font-size:16px;"></i> Courses/Subject</h3>
                                 <?php } ?>

                              <?php if($class_slot){ ?>
                                 <h3><i class="fa fa-fw fa-check-circle" style="color:green;font-size:16px;"></i> Class Batch</h3>
                                 <?php }else{ ?>
                                 <h3><i class="fa fa-fw fa-check-circle-o" style="color:#ccc;font-size:16px;"></i> Class Batch</h3>
                                 <?php } ?>

                              <?php if($my_institute){ ?>
                                 <h3><i class="fa fa-fw fa-check-circle" style="color:green;font-size:16px;"></i> Join Teachers</h3>
                                 <?php }else{ ?>
                                 <h3><i class="fa fa-fw fa-check-circle-o" style="color:#ccc;font-size:16px;"></i> Join Teachers</h3>
                                 <?php } ?>
      ...
      <div class="col-md-12 box-sdow card-data" style="padding:0px 0px 0px 0px;">
        ...
        <div class="card-iner">
          <table width="100%">
            ...
            <?php if ($clastime) {
               ?>
               <?php foreach ($clastime as $clastime) {
               ?>
            <tr>
            <td valign="top"><div class="lived" id="_sts_1">LIVE</div></td>
              <td>
              <button class="btn btn-block btn-primary btn-raised card-data-btn openliveclass" id="<?php echo $clastime['class_uid'] ?>_<?php echo $clastime['day_nm'] ?>">
              <div class="c-title" style="color:#fff"><?php echo $clastime['clas_title'] ?></div>
              <div class="c-sml"><?php echo $clastime['cls_time_show'] ?> - <?php echo $clastime['cls_time_show_to'] ?></div>
              <div class="c-sml">By, <?php echo $clastime['teacher_nm'] ?>  </div>
              </button>
              </td>
            </tr>
             <?php } ?>
            ...
            <td valign="top"></td>
              ...
              <div class="c-title">You have no class batch! Add now</div>
              </div>
              </td>
            </tr>
              <?php } ?>
  ...
  <div class="col-md-4" style="padding:5px;">
    ...
    <div class="row">
      <div class="col-md-12 box-sdow card-data" style="padding:0px 0px 0px 0px;">
        ...
        <div class="dropdown-divider" style="margin:0;"> </div>
         <button class="btn btn-block btn-default aro-btn open_materials" >
