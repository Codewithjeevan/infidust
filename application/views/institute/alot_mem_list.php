        ...
        <div class="col-md-12 box-sdow box-margin" style="padding:10px 10px 0px 10px;">
          <table width="100%">
            <tr>
              ...
              <div class="mid-dis-img2" style="width: 65px; height:65px;">
              <?php if($members['pro_pic']){ ?>
              <img src="<?php echo base_url().'assets/' ?>pro-sml/<?php echo $members['pro_pic'] ?>">
                <?php }else { ?>
                 <img src="<?php echo base_url().'assets-public/dist/img/icon/' ?>usert.svg" width="40" style="opacity:0.3">
                <?php } ?>
              </div>
            </td>
              <td>
              <h5 style="font-size:17px"><?php echo $members['teacher_nm'] ?></h5>
               <?php if($members['city']){ ?>
              <p style="font-size:12px"><?php echo $members['city'] ?>, <?php echo $members['state'] ?></p>
              <?php }else { ?>
                <p style="font-size:12px">Profile not set yet</p>
                <?php } ?>
              </td>
            </tr>
          </table>
         ...
         <div class="col-md-12" style="background:#fff; border:1px solid #ddd;padding:5%">
               ...
               <span align="center" style="color:#2196f3">https://infidust.com</span><br><br>
