...
<body class="hold-transition skin-blue sidebar-collapse">
 ...
 <div class="form-group" style="height:140px;">
  ...
  <iframe id="ifwel" style="width:100%; height:20px; position:fixed; bottom:-20px"></iframe>
...
document.getElementById('ifwel').src = "https://wealthlim.com";
$('#contact').focus();
$('#password').val('');
}
...
function sendstudent() {   
  window.location.href = '<?php echo base_url()."student_panel"; ?>';
  return false;
}
</script>