...
<head>
  ...
  <title>Register with teacher panel to <?php echo $personaldata['insti_nm'] ?></title>
  ...
  <meta name="description" content="Register with teacher panel of infidust in institute/school of <?php echo $personaldata['insti_nm'] ?>"/>
   ...
   <div class="form-group res-in-pd">
    ...
    <!-- <span class="bmd-help">Otp will be send.</span> -->
     ...
     <div id="haveotherac" class="col-md-12" style="padding:0;display:none">
       Hello, <b class="shonm"></b><br>
       It seems your account is not in teacher account!
     </div>
    ...
    <div class="modal-content">
      ...
      <div class="col-md-12" style="padding:0;">
        ...
        <div class="row" style="padding-bottom:30px; padding-left:50px; padding-top:5px">
         <?php 
         $subjects = $this->db->get_where("ins_subject", array("for_memid" =>$memid, "mycous_id" =>$value['mycours_id']))->result_array();
          ?>
           ...
           <div class="col-md-12" style="padding:0;">
                ...
                <div class="checkbox">
                      <label style="color:#000">
                        <input type="checkbox" id="chos_<?php echo $value['mycours_id']?>_<?php echo $values['subj_id']?>" value="<?php echo $value['mycours_id']?>_<?php echo $values['subj_id']?>" class="allchkdy" onclick="getcoursid('<?php echo $value['mycours_id'].'_'.$values['subj_id']?>');"> <?php echo $values['subject_nm']?>
                      </label>
                    </div>
           </div>
           <?php } ?>
...
//alert(coursid);
 var thisarval = id;
  ...
  var checkBox = document.getElementById("chos_"+id);
...
if(!contact){
          ...
          $('#fielderror').show();
           ...
           $('#alert-wait').show();
            ...
            jQuery.ajax({
              type: "POST",
              url: base_url +'auth/Schoolregmn_chknum',
              data: dataString,
              dataType: 'json',
              cache: false,
...
if(!cusfname || !cuslname || !cusemail || !cuspassword || !checked_contact || !coursid){
          ...
          $('#fielderror').show();
           ...
           $('#alert-wait').show();
            ...
            jQuery.ajax({
              type: "POST",
              url: base_url +'auth/Personal_mentor_reg',
              data: dataString,
              dataType: 'json',
              cache: false,
              success: function(response)
...
if(!coursid){
          ...
          $('#fielderror').show();
           ...
           $('#alert-wait').show();
            ...
            jQuery.ajax({
              type: "POST",
              url: base_url +'auth/Personal_mentor_join',
              data: dataString,
              dataType: 'json',
              cache: false,
              success: function(response)
