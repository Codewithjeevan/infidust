...
<style type="text/css">
  ...
  <div class="row ">
      ...
      <div class="col-md-12 body-data" style="padding-bottom:10px;"> <h3><i class="fa fa-fw fa-archive"></i> &nbsp;&nbsp;Choose your courses/type</h3></div>
     ...
     <div class="col-md-5 cours-pad2" align="" style="color:; ">
      ...
      <div class="col-md-12 body-data" style="padding-bottom:10px;"> <h3><i class="fa fa-fw fa-magic"></i> &nbsp;&nbsp;Our available Courses </h3></div>
