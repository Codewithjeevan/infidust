 ...
 <div class="top-btn-blk">
      ...
      ?>
        <div class="col-md-12 liveusersp">
          <table width="100%;">
            <tr>
              <td width="75"><div class="userrond-img"><img src="<?php echo base_url().'assets/' ?>pro-sml/<?php echo $student['pro_pic']?>"></div></td>
              <td>
...
<script src='<?php echo base_url().'assets-public/' ?>dist/js/chat.js'></script>
<script>
