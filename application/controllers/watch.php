...
defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 public function watchm(){
    $data['view'] = $view = $_GET['v'];
       ...
       if(!$this->session->userdata("mem_id")){
         redirect(base_url());
          ...
          $this->load->view('watchm/container',$data);
        }
     ...
     public function dashboard($view){
       ...
       $crnt_inst_data = $this->db->get_where("personal_data", array("mem_id" =>$crntviewid))->row_array();
      $data['inst_pro'] = $crnt_inst_data['pro_pic'];
  $data['materials'] = array();
     $data['watchthis'] =  $this->db->query("SELECT `materials`.*,
                                            `materials_details`.*,
...
if($this->session->userdata("crent_viewid")){
  if($this->session->userdata("mem_type") == 'student'){
     $data['myalotment'] = $myalotment = $this->db->get_where("class_alotment", array("studentid" =>$memid,"insid" =>$crntviewid))->row_array();
     } else if($this->session->userdata("mem_type") == 'teacher'){
     $data['myalotment'] = $myalotment = $this->db->get_where("class_alotment", array("teacherid" =>$memid,"insid" =>$crntviewid))->row_array();
     }
  ...
  $makesql = "";
     ...
     $data['materials'] =  $this->db->query("SELECT `materials`.*,
       ...
       $this->load->view('watchm/dashboard',$data);
 }
//////////////////////////////////////////
    ///////////////
